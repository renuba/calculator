...
public class CalculatorLocator extends org.apache.axis.client.Service implements org.tempuri.test.Calculator {
    ...
    public org.tempuri.test.CalculatorSoap getCalculatorSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.tempuri.test.CalculatorSoap getCalculatorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tempuri.test.CalculatorSoapStub _stub = new org.tempuri.test.CalculatorSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tempuri.test.CalculatorSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tempuri.test.CalculatorSoapStub _stub = new org.tempuri.test.CalculatorSoapStub(new java.net.URL(CalculatorSoap_address), this);
                _stub.setPortName(getCalculatorSoapWSDDServiceName());
                return _stub;
            }
        }
